...
pub struct SchemaDatabaseListResponse {
    #[serde(rename = "databases", skip_serializing_if = "Option::is_none")]
    pub databases: Option<Vec<crate::models::SchemaDatabase>>,
}

impl SchemaDatabaseListResponse {
    pub fn new() -> SchemaDatabaseListResponse {
