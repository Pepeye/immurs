...
pub struct SchemaVerifiableSetRequest {
    #[serde(rename = "setRequest", skip_serializing_if = "Option::is_none")]
    pub set_request: Option<Box<crate::models::SchemaSetRequest>>,
    #[serde(rename = "proveSinceTx", skip_serializing_if = "Option::is_none")]
    pub prove_since_tx: Option<String>,
}

impl SchemaVerifiableSetRequest {
    pub fn new() -> SchemaVerifiableSetRequest {
